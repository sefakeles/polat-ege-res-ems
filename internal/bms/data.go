...
func ParseBMSRackData(data []byte, id int, rackNo uint8) database.BMSRackData {
	...
	return database.BMSRackData{
		...
		TotalChargeEnergy:     utils.Scale(utils.FromBytes[uint32](data[104:108]), float32(0.1)),    // 1108-1109 - Cumulative charge energy (kWh)
		TotalDischargeEnergy:  utils.Scale(utils.FromBytes[uint32](data[108:112]), float32(0.1)),    // 1110-1111 - Cumulative discharge energy (kWh)
